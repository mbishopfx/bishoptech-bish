...
export function getMainPlans(): LandingPlan[] {
  return [
    ...
    },
    {
      ...
      billingPeriodLabel: m.pricing_billing_period_mo(),
      billingPeriodLabelEn: 'mo',
      description: 'For small businesses that need Google-backed RAG, approvals, and one listener bridge.',
...
export function getEnterprisePlan(): LandingPlan {
  return {
    ...
    href: 'mailto:sales@service.local',
    gradientId: '5',
    isEnterprise: true,
  }
}
...
export function getSelfHostingPlan(): LandingPlan {
  return {
    ...
    href: 'mailto:enterprise@service.local',
    gradientId: '6',
  }
}
