                ...
                <div className="flex flex-wrap items-center justify-between gap-3">
                  <div>
                    ...
                    <p className="mt-2 max-w-3xl text-foreground-secondary">
                      Huddles stay active as a collaboration layer while teammates move through the rest of BISH. The room state below already supports shared presence, reactions, and sticky notes.
                    </p>
                  </div>
                  <div className="flex items-center gap-2">
                    {myMembership ? (
