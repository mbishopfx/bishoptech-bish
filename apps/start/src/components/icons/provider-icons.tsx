...
/**
 * Reusable SVG icons for OAuth/auth providers.
 * Used in sign-in methods, connected accounts, and other auth-related UI.
 */
    ...
    >
      ...
      <defs>
        <clipPath id="xiaomi__clip">
          <rect width="534" height="534" rx="98" fill="white" />
        </clipPath>
      </defs>
    </svg>
  )
...
export function GitHubIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 1024 1024" fill="none" className={className} aria-hidden>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
