...
export const Route = createFileRoute('/legal/acceptable-use')({
  head: () => ({
    meta: buildPageMetadata({
      ...
      description:
        'Read the acceptable use policy, including prohibited activity, content restrictions, and account security expectations.',
    }),
  }),
            ...
            <div className="prose prose-sm dark:prose-invert max-w-none space-y-8">
              <section>
                ...
                <p className="text-foreground-primary dark:text-foreground-primary text-sm leading-6">
                  ...
                  and guidelines for acceptable use of our services, including
                  this website and any associated products or services
                  (collectively, the "Services"). By using the Services, you
                  agree to comply with this Policy. If you do not agree to this
                  Policy, you may not access or use the Services.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-foreground-primary dark:text-foreground-primary text-sm leading-6 mb-4">
                  By using our AI services, you agree to:
                </p>
                <ul className="list-disc pl-6 space-y-2 text-foreground-primary dark:text-foreground-primary text-sm leading-6">
                  <li>
                  ...
                  <li>
                    Understand that we do not guarantee the accuracy,
              ...
              <section>
                ...
                <ul className="list-disc pl-6 space-y-2 text-foreground-primary dark:text-foreground-primary text-sm leading-6">
                  <li>Not exceed the usage limits established by us;</li>
                  <li>
                    Not use the Services in a manner that may negatively affect
                    the performance of our servers or network;
                  </li>
                  <li>
              ...
              <section>
                ...
                <p className="text-foreground-primary dark:text-foreground-primary text-sm leading-6 mb-4">
                  If we determine, at our sole discretion, that you have
              ...
              <section>
                ...
                <p className="text-foreground-primary dark:text-foreground-primary text-sm leading-6">
                  We shall not be liable for any damage or harm arising from
