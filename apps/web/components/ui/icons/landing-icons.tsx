...
export function CentroConocimientoIcon({ className, ...props }: IconProps) {
  return (
    <svg
      width="48"
      height="48"
    ...
    >
      ...
      />
      <path
        d="M11.9611 6.57088C8.5758 5.9263 6.88314 5.60402 5.44156 6.83928C4 8.07454 4 10.0804 4 14.0922V28.51C4 32.1782 4 34.0122 4.9252 35.1574C5.8504 36.3024 7.8873 36.6902 11.9611 37.466C15.5927 38.1574 18.4269 39.259 20.4784 40.3662C22.4968 41.4554 23.506 42 24 42C24.494 42 25.5032 41.4554 27.5216 40.3662C29.5732 39.259 32.4074 38.1574 36.0388 37.466C40.1128 36.6902 42.1496 36.3024 43.0748 35.1574C44 34.0122 44 32.1782 44 28.51V14.0922C44 10.0804 44 8.07454 42.5584 6.83928C41.1168 5.60402 39.4242 5.9263 36.0388 6.57088"
        stroke="currentColor"
        strokeWidth="4"
        strokeLinecap="round"
        strokeLinejoin="round"
      ...
      <path
        opacity="0.4"
        d="M20.9042 6.00195V9.95999M13.9434 13.0027H18.0396M29.9594 13.0027H34.0556M29.9594 18.9492H34.0556M13.9434 18.9492H18.0396M20.9042 22.0404V25.9984M26.9438 22.0404V25.9984M26.9224 6.00195V9.95999M20.0358 21.937H27.9632C29.0656 21.937 29.9594 21.0416 29.9594 19.9371V11.96C29.9594 10.8554 29.0656 9.95999 27.9632 9.95999H20.0358C18.9334 9.95999 18.0396 10.8554 18.0396 11.96V19.9371C18.0396 21.0416 18.9334 21.937 20.0358 21.937Z"
        stroke="currentColor"
        strokeWidth="4"
        strokeLinecap="round"
      />
...
export function CustomSupportIcon({ className, ...props }: IconProps) {
  return (
    <svg
      width="48"
      height="48"
    ...
    >
      <path
        d="M24 44L20 32H4L8 44H24ZM24 44H32"
        stroke="currentColor"
        strokeWidth="4"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M24 26V25C24 21.2288 24 19.3431 22.8284 18.1716C21.6568 17 19.7712 17 16 17C12.2288 17 10.3431 17 9.17158 18.1716C8 19.3431 8 21.2288 8 25V26"
        stroke="currentColor"
        strokeWidth="4"
        strokeLinecap="round"
        strokeLinejoin="round"
      ...
      <path
        opacity="0.4"
        d="M38 26C38 28.2092 36.2092 30 34 30C31.7908 30 30 28.2092 30 26C30 23.7908 31.7908 22 34 22C36.2092 22 38 23.7908 38 26Z"
        stroke="currentColor"
        strokeWidth="4"
      />
      <path
        d="M20 8C20 10.2091 18.2091 12 16 12C13.7909 12 12 10.2091 12 8C12 5.79086 13.7909 4 16 4C18.2091 4 20 5.79086 20 8Z"
        stroke="currentColor"
        strokeWidth="4"
      />
      <path
        opacity="0.4"
        d="M28 35H40C42.2092 35 44 36.7908 44 39V40C44 42.2092 42.2092 44 40 44H38"
        stroke="currentColor"
        strokeWidth="4"
        strokeLinecap="round"
      />
...
export function EarlyAccessIcon({ className, ...props }: IconProps) {
  return (
    ...
    >
      ...
      <path
        opacity="0.4"
        d="M36 16H38C40.8284 16 42.2426 16 43.1214 16.8787C44 17.7574 44 19.1716 44 22V38C44 40.2092 42.2092 42 40 42C37.7908 42 36 40.2092 36 38V16Z"
        stroke="currentColor"
        strokeWidth="4"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M24 6H16C10.3431 6 7.51472 6 5.75736 7.75736C4 9.51472 4 12.3431 4 18V30C4 35.6568 4 38.4852 5.75736 40.2426C7.51472 42 10.3431 42 16 42H40C37.7908 42 36 40.2092 36 38V18C36 12.3431 36 9.51472 34.2426 7.75736C32.4852 6 29.6568 6 24 6Z"
        stroke="currentColor"
        strokeWidth="4"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function FastMessagesIcon({ className, ...props }: IconProps) {
  return (
    <svg
      width="48"
      height="48"
...
export function GuiasAIIcon({ className, ...props }: IconProps) {
  return (
    <svg
      width="48"
      height="48"
    ...
    >
      ...
      />
      <path
        d="M40 44H12C9.79086 44 8 42.2092 8 40M8 40C8 37.7908 9.79086 36 12 36H40V12C40 8.22876 40 6.34314 38.8284 5.17158C37.6568 4 35.7712 4 32 4H20C14.3431 4 11.5147 4 9.75736 5.75736C8 7.51472 8 10.3431 8 16V40Z"
        stroke="currentColor"
        strokeWidth="4"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M39 36C39 36 37 37.5256 37 40C37 42.4744 39 44 39 44"
        stroke="currentColor"
        strokeWidth="4"
        strokeLinecap="round"
        strokeLinejoin="round"
